...
[See a recorded fictional example](EXAMPLE.md) · [Download the prototype](https://github.com/maxprof824-jpg/intelligent-logging-formatter/releases/tag/v2.5.0-poc)
...
For several incidents, add an `EVENT: short name` heading above each one's notes. Each gets its own five-section draft, and repeating a label adds later updates to that event. Without headings, notes stay together; the app does not guess which incidents belong together.
...
Download the **tester ZIP** from the [release page](https://github.com/maxprof824-jpg/intelligent-logging-formatter/releases/tag/v2.5.0-poc), extract it, and run **SETUP-WINDOWS.cmd**, followed by **RUN-DEMO.cmd**.
...
For details, see the [usage guide](V2-GUIDE.md), [model and training notes](MODEL-CARD-V2.md), [2.5 validation record](reports/VALIDATION-V25.md), [roadmap](REVIEW-AND-ROADMAP.md), and [third-party attribution](THIRD-PARTY-NOTICES.md).
